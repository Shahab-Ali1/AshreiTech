        ...
        <Slider {...settings}>
          ...
          <Card >
            <div className="card-body pb-0">
              ...
              <p className="card-text mb-3 mt-3">Thanks to AshreiTech. Everything I learned from soft skills to technical expertise, has directly helped me in my job at Secure Beans in the HR department. My journey has been amazing.</p>
          ...
          <Card >
            <div className="card-body pb-0">
              ...
              <p className="card-text mb-3 mt-3">The courses offered by AshreiTech were very interesting, so I decided to enroll in them. I am glad I made this decision because the trainers are extremely helpful</p>
              <div className="row justify-content-between mt-3">
                <div className="col" style={{ color: '#DBDBDB' }}>
                  08:21 PM - Jan 4, 2023
                </div>
          ...
          <Card >
            <div className="card-body pb-0">
              ...
              <p className="card-text mb-3 mt-3">“We had no prior knowledge of IT but after we took admission in AshreiTech we got to learn a lot and both of us secured jobs as soon as we acquired our certifications. 
              </p>
              <div className="row justify-content-between mt-3">
                <div className="col" style={{ color: '#DBDBDB' }}>
                  08:21 PM - Jan 4, 2023
          ...
          <Card >
            <div className="card-body pb-0">
              ...
              <p className="card-text mb-3 mt-3">I got my first job after I did my course in Oracle Financials General Ledger from AshreiTech. The experience was amazing, the trainers were really helpful.</p>
              <div className="row justify-content-between mt-3">
                <div className="col" style={{ color: '#DBDBDB' }}>
                  08:21 PM - Jan 4, 2023
                </div>
