...
const InfoCard = (props) => {
    ...
    return (
        <ScrollTrigger onEnter={() => setCounter(true)} onExit={() => setCounter(false)}>
            {
                windowWidth >580 ?<div className={`${Info_container} p-1 mt-5 mx-0 mx-lg-5`}>
                <div className={`d-flex   ${props?.data?.length === 4 ? 'px-sm-5 justify-content-between' : 'flex-wrap justify-content-center'} align-items-center pt-4`}>
